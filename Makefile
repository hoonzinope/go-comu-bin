...
.PHONY: help build run swagger verify verify-swagger test test-unit test-integration clean
...
help:
	...
	@echo "  make verify-swagger   Verify docs/swagger is in sync"
	@echo "  make verify           Run tests, vet, and swagger verification"
