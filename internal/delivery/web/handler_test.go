...
func TestHandler_RenderCoreScreens(t *testing.T) {
	...
	t.Run("post detail", func(t *testing.T) {
		...
		assert.Contains(t, rr.Body.String(), "Board")
		assert.Contains(t, rr.Body.String(), "Author")
		assert.Contains(t, rr.Body.String(), "Timing")
		assert.Contains(t, rr.Body.String(), "Activity")
