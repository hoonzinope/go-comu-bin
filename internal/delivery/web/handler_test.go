...
func TestHandler_RenderCoreScreens(t *testing.T) {
	...
	t.Run("guest navigation hides auth-only links", func(t *testing.T) {
		...
		assert.Contains(t, body, `sidebar-dir-title">Discussion directory`)
...
func TestHandler_RenderEmptyStateSurfaces(t *testing.T) {
	t.Run("feed", func(t *testing.T) {
		...
		require.Equal(t, http.StatusOK, rr.Code)
		body := rr.Body.String()
		assert.Contains(t, body, "No threads yet")
		assert.Contains(t, body, "Start the first discussion")
		assert.Contains(t, body, "Start thread")
	...
	t.Run("search", func(t *testing.T) {
		...
		assert.Contains(t, body, "Try a broader term or switch boards")
		assert.Contains(t, body, "Open directory")
