...
type PostRepository interface {
	...
	SelectDraftPostsByAuthorID(ctx context.Context, authorID int64, limit int, lastID int64) ([]*entity.Post, error)
	CountDraftPostsByAuthorID(ctx context.Context, authorID int64) (int, error)
	...
	CountPublishedPostsByBoardID(ctx context.Context, boardID int64) (int, error)
	SelectPublishedPostsByTagName(ctx context.Context, tagName string, limit int, lastID int64) ([]*entity.Post, error)
	CountPublishedPostsByTagName(ctx context.Context, tagName string) (int, error)
