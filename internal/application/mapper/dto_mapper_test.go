...
func TestEntityMappers(t *testing.T) {
	...
	post := PostFromEntity(&entity.Post{ID: 2, UUID: "post-uuid", Title: "t", Content: "Lead summary.\n\nBody paragraph.", AuthorID: 3, BoardID: 4, CreatedAt: now, UpdatedAt: now})
	...
	assert.Equal(t, "Lead summary.", post.Summary)
