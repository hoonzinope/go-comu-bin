...
func NewService(credentialVerifier port.CredentialVerifier, guestIssuer port.GuestAccountIssuer, userRepository port.UserRepository, tokenPort port.TokenProvider, sessionRepository port.SessionRepository) *Service {
	return NewSessionService(credentialVerifier, guestIssuer, userRepository, tokenPort, sessionRepository)
}
