...
func TestReactionService_SetReaction_CreatesWhenMissing(t *testing.T) {
	...
	reactionSvc := NewReactionServiceWithPublisher(repositories.user, repositories.post, repositories.comment, repositories.reaction, repositories.unitOfWork, cache, newTestEventPublisher(repositories, cache), newTestCachePolicy())
